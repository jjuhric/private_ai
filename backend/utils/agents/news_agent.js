...
4. **Current & Online Info Requirement**: Any information being gathered must be online and current via tools, searches, etc. If current online information is not available after attempting every way possible, specifically state that the news/information presented is from data up to the LLM knowledge cutoff date.
