...
async function main(argv = process.argv) {
  ...
  try {
    ...
    let modelName = process.env.PREFERRED_LOCAL_MODEL || 'qwen/qwen2.5-coder-14b';
    ...
    `, [
      ...
      encryptedOnlineKey,
      onlineProvider,
      args.preferred_local_model || process.env.PREFERRED_LOCAL_MODEL || 'qwen/qwen2.5-coder-14b',
