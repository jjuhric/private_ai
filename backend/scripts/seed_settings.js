...
async function main(argv = process.argv) {
  ...
  try {
    ...
    let modelName = process.env.PREFERRED_LOCAL_MODEL || 'qwen2.5-coder-3b-instruct';
    ...
    `, [
      ...
      encryptedOnlineKey,
      onlineProvider,
      args.preferred_local_model || process.env.PREFERRED_LOCAL_MODEL || 'qwen2.5-coder-3b-instruct',
      args.preferred_online_model || process.env.PREFERRED_ONLINE_MODEL || 'qwen2.5-coder-3b-instruct',
      args.supervisor_model || process.env.SUPERVISOR_MODEL || 'qwen2.5-coder-3b-instruct',
      deviceType,
      isMainHost,
      workingDir
    ]);
